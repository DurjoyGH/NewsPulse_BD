    ...
    <header className="bg-white font-sans border-b sticky top-0 z-50 shadow-sm">
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center py-3 sm:py-5 px-4 sm:px-6">
        ...
        <div className="hidden md:flex items-center gap-2 sm:gap-3">
          ...
          <div className="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-full border bg-gray-100 hover:bg-gray-200 transition-colors cursor-pointer">
      ...
      >
        <div className="border-t bg-gray-50 max-h-[calc(100vh-80px)] overflow-y-auto">
          ...
          <div className="flex items-center gap-3 p-4 border-b bg-white">
            <div className="w-10 h-10 flex items-center justify-center rounded-full border bg-gray-100">
              <User className="w-5 h-5 text-gray-700" />
            </div>
            <span className="text-sm font-medium">News Portal</span>
          </div>
